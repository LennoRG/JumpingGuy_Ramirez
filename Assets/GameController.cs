...
public class GameController : MonoBehaviour {
    ...
    void Parallax()
    {
        float finalSpeep = parallaxSpeed * Time.deltaTime;
        background.uvRect = new Rect(background.uvRect.x + finalSpeep, 0f, 1f, 1f);
        platform.uvRect = new Rect(background.uvRect.x + finalSpeep * 4, 0f, 1f, 1f);
    ...
    public void SaveScore(int currentPoints){
        PlayerPrefs.SetInt("Max Point", currentPoints);
